...
const SubFooter = () => {
  return (
    ...
    shadow-[0_2px_15px_-3pxrgba(0,0,0,0.07),0_10px_20px_-2pxrgba(0,0,0,0.04)] md:flex-row relative'>
        <img src = '/lower-banner.jpg' alt="" 
        className='h-96 w-full object-cover md:h-[60vh] lg:h-[80vh]'/>
    <div className='flex flex-col justify-center gap-8 mf:px-16 px-8 md:my-0 my-8'>
