            ...
            <div className='grid grid-cols-1 p-4 mt-10'>
                ...
                <div className='pt-8'>
                    <div className='flex justify-between items-center border-b mb-5 pb-5'>
                            ...
                            <p className='text-lg font-bold'> Price: <span className='text-2xl'>${price}</span>  </p>
                        </div>
                         ...
                         <button className='bg-third-color text-white font-bold w-full py-2.5 px-4 rounded-md' onClick={Submit}> Pay Now </button>
                    </div>
            </div>
