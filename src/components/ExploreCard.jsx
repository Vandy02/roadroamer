...
const ExploreCard = ({world}) => {
  return (
    <div className='text-center w-full sm:mx-auto mt-16 shadow-xl text-gray-900 px-10 py-6 gradient-05 sma:p-8 rounded-lg border-third-color border-2 relative cursor-pointer hover:shadow-third-color'>
